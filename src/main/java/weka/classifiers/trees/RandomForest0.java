 ...
 */
public class RandomForest0 extends AbstractClassifier implements OptionHandler,
        Randomizable, WeightedInstancesHandler, AdditionalMeasureProducer,
        TechnicalInformationHandler, PartitionGenerator, Aggregateable<RandomForest0> {
    ...
    /** The bagger. */
    protected Bagging2 m_bagger = null;
    ...
    public static void main(String[] argv) {
        runClassifier(new RandomForest0(), argv);
    }

    @Override
    public RandomForest0 aggregate(RandomForest0 toAggregate) throws Exception {
