...
//    runClassifier(new J48(), argv);
        ...
        String file = "/home/davi/working-copies/arff/SAHeart.arff";
        Instances data = new ConverterUtils.DataSource(file).getDataSet();
        data.setClassIndex(data.numAttributes() - 1);

        Instances data1 = new Instances(data, 0, 200);
        c.buildClassifier(data1);
        double[] arr = c.distributionForInstance(data.get(0));
